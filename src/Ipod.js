                ...
                <div id='inner-container' style = {styles.wheel} onMouseOver={this.rotateWheel}>
                    <div style = {styles.buttonContainer}>
                        <div style = {styles.menuButton}>
                            <a onClick={this.changePageToHomeScreen} style = {styles.image} >MENU</a>
                        </div>
...
// internal css are here except the hover part which is in index.css
const styles = {
    ipodContainer : {
        height : '33rem',
        width : '20rem',
        backgroundImage: 'linear-gradient(135deg , yellow , orange)',
        margin : '4rem auto',
        display : 'flex',
        flexDirection : 'row',
        flexWrap : 'wrap',
