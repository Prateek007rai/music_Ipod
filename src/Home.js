...
const styles = {
    ...
    imageContainer : {
        ...
        height : '100%',
        width : '50%',
        backgroundImage : 'url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRSJqeCF9ephwOEbBGX3TQMmRdrDOB8f1tq2A&usqp=CAU")',
    ...
    titleBar : {
        ...
        backgroundImage: 'linear-gradient(0deg, lightGrey, transparent)',
